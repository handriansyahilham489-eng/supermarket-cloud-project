...
Original file is located at
    https://colab.research.google.com/drive/1Zw5o_J5OiHuRNrIcVFFIykvQeZDqqcq8
"""
...
model = pickle.load(open('/content/drive/MyDrive/Colab Notebooks/Cloud Computing/model_penjualan.pkl', 'rb'))
